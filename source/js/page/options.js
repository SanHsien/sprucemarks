...
const custom_checkbox = local.class.custom_checkbox = class custom_checkbox extends HTMLInputElement {
    ...
    */
    ...
    constructor() {
        ...
        // set initial state
        this.checked = local.option[property] ?? false // true or false
        ...
        this.addEventListener('click', function(e) {
            ...
            // dynamically read current property to support elements configured after cloning
...
const setup_sort_options = local.function.setup_sort_options = function setup_sort_options() {
    ...
    */
    ...
    for (const property of ancestors) {
        ...
        checkbox[0].checked = local.option[property] ?? false
        checkbox[1].dataset.option = property + '_sub'
        checkbox[1].checked = local.option[property + '_sub'] ?? false
        ...
        select[0].value = local.option[property + '_sort'] ?? ''
        select[1].dataset.option = property + '_sub_sort'
        select[1].value = local.option[property + '_sub_sort'] ?? ''
        ...
        if (img.src !== '' || img_sub.src !== '') {
            ...
            if (img_sub.src !== '') {
                img_sub.src += '?version=2025.6.26.0'
                img_sub.alt = ''
